...
func New(ctx context.Context, h host.Host, permissionLayer dht_permission_layer.PermissionLayer, options ...opts.Option) (*IpfsDHT, error) {
...
func NewDHT(ctx context.Context, h host.Host, dstore ds.Batching, permissionLayer dht_permission_layer.PermissionLayer) *IpfsDHT {
...
func NewDHTClient(ctx context.Context, h host.Host, dstore ds.Batching, permissionLayer dht_permission_layer.PermissionLayer) *IpfsDHT {
...
func makeDHT(ctx context.Context, h host.Host, dstore ds.Batching, protocols []protocol.ID, bucketSize int, permissionLayer dht_permission_layer.PermissionLayer) *IpfsDHT {
