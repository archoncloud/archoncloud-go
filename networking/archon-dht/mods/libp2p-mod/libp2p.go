...
import (
	...
	config "github.com/itsmeknt/archoncloud-go/networking/archon-dht/mods/libp2p-mod/config"
...
func NewPermissioned(ctx context.Context, permissionLayer dht_permission_layer.PermissionLayer, opts ...Option) (host.Host, error) {
...
func NewPermissionedWithoutDefaults(ctx context.Context, permissionLayer dht_permission_layer.PermissionLayer, opts ...Option) (host.Host, error) {
	var cfg Config
	if err := cfg.Apply(opts...); err != nil {
		return nil, err
	}
